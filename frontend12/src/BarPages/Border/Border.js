...
const Border = () => {
    ...
    return<div className="marginBox60" >
    <div className={"top_title_area"}>
         <div className={"top_title"}>게시판</div>
         <img src={mypage_btn} width="30px"  style={{marginTop:"12px" ,marginRight:"30px"}} height="30px" onClick={()=>navigate('/My_page')}/>
          </div>
